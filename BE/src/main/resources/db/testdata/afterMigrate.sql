...
VALUES
    ...
    (-2, 'Customer 2', '456 Elm St', '555-987-6543', 'customer2@example.com', 'CUST002');
...
VALUES
    ...
    (-2, 2, false, 'Wooden facade', '2nd floor', 40, false, true);
...
VALUES
    ...
    (-2, 2, '2023-11-02', '2023-11-06', '2023-11-16', 'Notes for order 2', 2, 2);
...
VALUES
    ...
    (-2, 2, 'Outside Mount', 200, 180, 'Weave 2', 'Model B', 'Wall', true, 'Motorized', 'Right', 'Black', 'Black', false, true);
...
VALUES
    ...
    (-2, 2, 'Inside Mount', 'Model Y', 'Weave 4', 'Manual', 400, 300, 'Wooden facade', false, true, false, true);
